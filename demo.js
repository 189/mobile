/*! TenVideoPlayer_V2 - v2.0.0 - 2015-01-07 20:21:35
 * Copyright (c) 2015
...
! function(global) {
    ...
    var tvp = {};
    tvp.lastModify = "2015-01-07 20:21:35", tvp.ver = "$V2.0Build3365$", tvp.name = "\u817e\u8baf\u89c6\u9891\u7edf\u4e00\u64ad\u653e\u5668";
    var top = window.top;
    if (top != window) try {
    ...
    "undefined" != typeof Zepto && Zepto._tvp ? (tvp.$ = Zepto, _isUseInnerZepto = !0) : (tvp.$ = {}, _isUseInnerZepto = !1),
            ...
            function b(b) {
                {
                    var c = b.match(/MQQBrowser\/(\d+\.\d+)/i),
                        ...
                        n = b.match(/(iphone)\sos\s([\d_]+)/i),
                        o = b.match(/Chrome\/(\d+\.\d+)/),
                        p = b.match(/Mozilla.*Linux.*Android.*AppleWebKit.*Mobile Safari/),
                        q = b.match(/(android)\s([\d\.]+)/i);
                    b.indexOf("HTC") > -1
                }
        ...
        function(a, b) {
            ...
            pluginUrl: {
                AppBanner: "js/plugins/appbanner.js?v=20141231",
                AppFollow: "js/plugins/appfollow.js?v=20141231",
                AppRecommend: "js/plugins/apprecommend.js?v=20141231",
                AppDownloadOnPause: "js/plugins/appdownloadonpause.js?v=20141231",
                AppBannerOnPause: "js/plugins/appbanneronpause.js?v=20141231",
                AppDownloadClickWechat: "js/plugins/appdownloadclickwechat.js?v=20141231",
                AppDownloadClickMqq: "js/plugins/appdownloadclickmqq.js?v=20141231"
            },
    ...
    var QQLive = QQLive || {
            ver: "$Rev: 67561 $",
            curSSO: "",
            lastmodify: "$Date: 2015-01-07 20:25:26 +0800 (涓�, 2015-01-07) $"
        },
        QQLiveSetup = QQLive;
...
}(this); /*  |xGv00|d0ffdd307ab9d628ddfe7dfcdf910a99 */
